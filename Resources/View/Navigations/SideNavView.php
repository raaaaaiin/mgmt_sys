...
<div class=" solid" style="height:65px;background-color:#3166e1 !important">
  ...
  <div class="navigationtop-nav" style="height:100%;display:flex;align-items: center;">
    ...
    <span style="font-size:26px; color:white;"><strong class="navbrandgreen" style="color:white">&nbsp;MGMT</strong>
      sys</span>
  </div>
  </div>
  ...
  <div class="banner" style="margin-top:25px;margin-bottom:25px;">
    ...
    <img src="https://via.placeholder.com/75" style="float:left; border-radius: 50%; filter: invert(0%)!important;"
      width="50" height="50">
  ...
  <a href="DiscoverController" target="FraDisplay"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
      fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
      <path fill-rule="evenodd"
        d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z" />
    </svg>&nbsp;Discover</a>

  <a href="NewsfeedController" target="FraDisplay"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
  ...
  <a href="TimelineController" target="FraDisplay"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
  ...
  <a href="ProfileController" target="FraDisplay"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
  ...
  <a href="ItemListController" target="FraDisplay"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
  ...
  <a href="ItemAddController" target="FraDisplay"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
...
<!--
  <a href="underdev.php" target="FraDisplay"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
  ...
  <a href="Resident/resident.php" target="FraDisplay"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
  ...
  <a href="accountLogout.php" target="_Parent"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
