                  ...
                  <div class="dashcard mt-3">
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span class="text-secondary">09212886190</span>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 class="mb-0">
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span class="text-secondary">BSCS 801</span>
                      </li>
					  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 class="mb-0">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mortarboard" viewBox="0 0 16 16">
                        ...
                        <span class="text-secondary">Penalty
123 PHP</span>
                      </li>
              ...
              <div wire:ignore="" class="card-body yellow">
                <script>
                  ...
                  <div class="alert alert-light" role="alert">
                    <h4 class="alert-heading m-0" style="font-size:16px">Book below is scheduled on: 12/27/2000 </h4>
                  </div> 
                  <div class="card">
                    <div class="additional">
                      ...
                      <div class="more-info">
                        <div class="coords p-2 m-0">
                          <span class="titles">Title: <span class="span">TItle</span>
                          </span>
                          <br>
                          <span class="titles">Accession: <span class="span">Accession</span>
                          </span>
                          <br>
                          <span class="titles" style="@if($borrowing > $today)
                               color:Red

                                  @endif">Borrow Date: <span class="span">Borrowed</span>
                          </span>
                          <br>
                          <span class="titles">Return Date: <span class="span">Returned</span>
                          </span>
                          <br>
                          <span class="titles">Borrower: <span class="span">Name</span>
                          </span>
                          <br>
                          <span class="titles">Issuer: <span class="span"> Issue</span>
                          </span>
                          <br>
                          <br>
                    ...
                    <div class="general p-2 m-0 d-flex" style="flex-direction: column;    justify-content: space-between;">
                      <div>
                        ...
                        <span class="titles">Late: <span class="span">Return : Delayed</span>
                        </span>
                        <br>
                        <span class="titles">Expiration: <span class="span">Must Return Now 
</span>
                        </span>
                        <br>
                        <span class="titles">Penalty: <span class="span">35 PHP</span>
                        </span>
                        <br>
...
<div class="col-md-3">
                ...
                <div class="dashcard mb-3">
                  <div class="dashcard-body pb-0">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7 text-secondary"> Admin, Student, BSCS </div>
                    </div>
                    <hr>
                    <div class="row">
                      <div class="col-sm-5">
    ...
    font-weight: 600;
">A book was successfully returned.</h5> 331234 <h5 style="
    margin-left:10px!important;margin: 0;
    padding: 0;
    border: 0;
    font-size: 14px!important;
    ...
    color: #000;
    text-transform: capitalize;
">Refference:Accession</h5>  <h5 style="
    margin-left:10px!important;margin: 0;
    padding: 0;
    border: 0;
    font-size: 14px!important;
...
">Returned On: Returned</h5>
    ...
    color: #000;
    text-transform: capitalize;
">Status: Status <span class="badge badge-warning float-right" style=" font-size: 14px!important;">Pending</span> <span class="badge badge-success float-right" style=" font-size: 14px!important;">Returned</span> </h5>
